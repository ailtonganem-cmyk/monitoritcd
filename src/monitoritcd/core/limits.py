...
MAX_EXTRA_TOPICS: Final[int] = 20  # topics extras dinâmicos via /topicos
MIN_TOPIC_DESCRIPTION_LENGTH: Final[int] = 10
MAX_TOPIC_DESCRIPTION_LENGTH: Final[int] = 200
MAX_TOPIC_ID_LENGTH: Final[int] = 32
