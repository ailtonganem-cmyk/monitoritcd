...
> janelas/CLIs distintas sobre a mesma árvore, enxerguem o progresso uns dos
...
Confirmação. O trabalho roda na árvore principal (`80`); o ESTADO vive em
`_trabalho/` dela — todos os agentes da tarefa apontam para o mesmo arquivo.
